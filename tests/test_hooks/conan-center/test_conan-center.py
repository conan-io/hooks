...
class ConanCenterTests(ConanClientTestCase):
    ...
    def test_conanfile_header_only(self):
        ...
        self.assertNotIn("ERROR: [NO F-STRINGS (KB-H038)]", output)
        self.assertIn("ERROR: [PACKAGE LICENSE (KB-H012)] No 'licenses' folder found in package", output)
        self.assertIn("[DEFAULT PACKAGE LAYOUT (KB-H013)] OK", output)
        self.assertIn("[SHARED ARTIFACTS (KB-H015)] OK", output)
        self.assertIn("[EXPORT LICENSE (KB-H023)] OK", output)
    ...
    def test_f_strings(self):
        ...
        self.assertNotIn("ERROR: [NO F-STRINGS (KB-H038)] Line (1):", output)
        self.assertNotIn("ERROR: [NO F-STRINGS (KB-H038)] Line (10):", output)
        self.assertIn("ERROR: [NO F-STRINGS (KB-H038)] Line (13): Python f-strings (PEP 498) is not allowed in Conan recipes.", output)
        self.assertIn("ERROR: [NO F-STRINGS (KB-H038)] Line (14): Python f-strings (PEP 498) is not allowed in Conan recipes.", output)
